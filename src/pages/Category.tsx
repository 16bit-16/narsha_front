...
export default function Category() {
    ...
    const loadProducts = async () => {
        ...
        try {
            ...
            if (data.ok) {
                console.log("로드된 상품:", data.products);  // 디버깅
                ...
                <div className="flex w-full gap-2 px-4 py-4 overflow-x-auto text-sm snap-x">
                    {CATEGORIES.map((category) => (
                        <button
                            ...
                            className={`px-4 py-2 border rounded-full min-w-fit snap-start transition-colors whitespace-nowrap ${selectedCategory === category
